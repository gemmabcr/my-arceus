...
class CaughtToDoAdapter(private val toDo: CaughtToDo) : BaseToDoAdapter() {
    override fun baseI18nKey() = CaughtConditionI18nKey.BASE

    override fun adapter(): I18nKeyAdapter? = toDo.condition?.let { CaughtConditionI18nKeyAdapter(it) }
}
